...
const audioEngine = fs.readFileSync("app/javascript/pocket_synth/audio_engine.js", "utf8")
...
const sequencer = fs.readFileSync("app/javascript/pocket_synth/audio/step_sequencer.js", "utf8")
